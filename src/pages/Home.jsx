      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-24">
          ...
          <p className="mt-8 text-md text-gray-600 max-w-3xl mx-4 md:mx-16 lg:mx-auto">
            Aura Access is a sophisticated web application designed using React
            and face-api.js, offering an advanced facial recognition-based
            authentication system. The primary goal of Aura Access is to provide
            a secure and efficient method for user verification by analyzing and
            validating facial features, ensuring a seamless and reliable
